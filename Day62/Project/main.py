...
def add_cafe():
    ...
    if form.validate_on_submit():
        ...
        with open('/workspaces/1oo_days_of_code/Day62/Project/cafe-data.csv', mode='a', newline='', encoding='utf-8') as csv_file:
...
@app.route('/cafes')
def cafes():
    with open('/workspaces/1oo_days_of_code/Day62/Project/cafe-data.csv', newline='', encoding='utf-8') as csv_file:

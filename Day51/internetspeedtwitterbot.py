...
class InternetSpeedTwitterBot:
    ...
    def get_internet_speed(self):
        ...
        time.sleep(90)
        down = float(self.driver.find_element(By.XPATH, value='//*[@id="container"]/div[1]/div[3]/div/div/div/div[2]/div[3]/div/div[3]/div/div[3]/div/div/div[2]/div[1]/div[1]/div/div[2]/span').text)
        up = float(self.driver.find_element(By.XPATH, value='//*[@id="container"]/div[1]/div[3]/div/div/div/div[2]/div[3]/div/div[3]/div/div[3]/div/div/div[2]/div[1]/div[2]/div/div[2]/span').text)
    ...
    def tweet_at_provider(self):
        ...
        next.click()
        time.sleep(5)
        # # This step is required if x finds out an unusual login
        # id = self.driver.find_element(By.XPATH, value='//*[@id="layers"]/div/div/div/div/div/div/div[2]/div[2]/div/div/div[2]/div[2]/div[1]/div/div[2]/label/div/div[2]/div/input')
        # id.send_keys("test100daysofcd")
        # next_2 = self.driver.find_element(By.XPATH, value='//*[@id="layers"]/div/div/div/div/div/div/div[2]/div[2]/div/div/div[2]/div[2]/div[2]/div/div/div/button')
        # next_2.click()
        # time.sleep(5)
